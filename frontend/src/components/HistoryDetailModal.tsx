        ...
        <div className="p-5 flex-grow overflow-y-auto space-y-5">
          <div>
            <div className="flex justify-between items-start">
              <div>
                <h3 className="text-2xl font-extrabold text-[#151c27]">{item.dishName}</h3>
              ...
              <div className="text-right">
                <span className="block text-xl font-extrabold text-[#855300]">{item.calories} KCAL</span>
                <span className="text-xs text-[#3c4a42] font-semibold">{item.date}</span>
              </div>
            </div>
            {item.description && (
